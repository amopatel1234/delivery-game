...
TestFlight internal group: **`Internal`**. Enable **Automatic distribution** on that group in App Store Connect — Fastlane uploads only and does not assign groups (ASC rejects API assignment to Internal).
